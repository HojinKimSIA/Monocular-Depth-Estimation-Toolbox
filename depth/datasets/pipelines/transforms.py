...
class DSM_Transform(object):
    def __init__(self,
        ...
        for tr in tr_list:
            if tr is 'random_crop':
                self.tr_list.append(A.RandomCrop(crop_size, crop_size))
            if tr is 'resize':
